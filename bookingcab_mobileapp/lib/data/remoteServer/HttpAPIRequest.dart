...
const String INVALID_ALT_EMAIL_ID_MSG = "Please enter the valid alternate email id";
const String INVALID_PHONE_NO_MSG = "Please enter the valid mobile no";
const String INVALID_ALT_PHONE_NO_MSG = "Please enter the valid alternate mobile no";
const String INVALID_LANDINE_NO_MSG = "Please enter the valid landline no";
const String INVALID_ALT_HONE_NO_MSG = "Please enter the valid alternate mobile no";
...
const String INVALID_COMAPNY_Office_Address_MSG = "Please enter your company office address";
const String INVALID_COMAPNY_PAN_MSG = "Please enter your company PAN Card No";
const String INVALID_COMAPNY_Aadhar_MSG = "Please enter your company Aadhar card no";
const String INVALID_COMAPNY_CONTACT_PERSONAL_NAME_MSG = "Please enter your company contact persion name";
